...
eight review passes; every finding is fixed on the branch and the rulings are DESIGN-051 D-13..D-15ac (the
...
when TMDB's page leaves it out (D-15ac). Code comments cite those D-IDs, never a "ruling N" number. **Next:** merge #580 once its required checks are green → S3 release
