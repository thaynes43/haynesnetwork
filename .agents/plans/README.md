...
| 044 | Goodreads requests MVP (Integrations tab + Missing) | **ACTIONABLE — rulings locked; overnight Opus dispatch** | Owner-first linking, app-side RSS sync, no-gate requests (all become Missing; SAB rips, MAM governor gates), both formats always, coverage % + manual search. Subsumes PLAN-033's requester scope. |
