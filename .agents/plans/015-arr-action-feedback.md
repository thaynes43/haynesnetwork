...
- **Status:** Executing
  <!-- Backend vertical built on branch feat/arr-feedback (2026-07-07): queue read client
       ...
       glossary T-90/T-91/T-92/T-93; PRD R-106/R-107; NO migration (derive-not-persist). The
       progress UI (chips/bars on Fix + Force-Search, live My Fixes phases, the roll-up child
       display, the Fix-button open-fix disable) is a separate Fable UX follow-up. -->
