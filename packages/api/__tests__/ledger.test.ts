...
describe('ledger.children (D-06 live proxy)', () => {
  it('proxies sonarr episodes live with SxxEyy labels', async () => {
    ...
    expect(children).toEqual([
      // PLAN-030 — `episodeNumber` now rides along (the Plex episode-still merge key).
      { arrChildId: 30101, label: 'S01E01 · Pilot', hasFile: true, monitored: true, seasonNumber: 1, episodeNumber: 1 },
      { arrChildId: 30102, label: 'S01E02 · Rich', hasFile: false, monitored: true, seasonNumber: 1, episodeNumber: 2 },
    ]);
