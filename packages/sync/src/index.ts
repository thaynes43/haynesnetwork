...
// ADR-081 C-04 — the boot-triggered first plex-match trigger: an advisory-locked, non-blocking, run-once
// helper the web app's instrumentation hook fires on start to close the cold-start window.
export * from './first-plex-match';
